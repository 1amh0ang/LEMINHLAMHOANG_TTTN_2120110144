...
namespace VietnamWatches.Areas.Admin.Controllers
{
    ...
    {
        private CuaHangTienLoiDbContext db = new CuaHangTienLoiDbContext();
        ...
        public ActionResult Edit(Contact contact)
        {
            if (ModelState.IsValid)
            {
                ...
                mail.Subject = "Phản hồi mới từ VietnamWatches";
                ...
                content += "<p>VietnamWatches đã xác nhận cho bạn đầy đủ với các phản hồi được liệt kê bên dưới theo số điện thoại gửi&nbsp;<strong>#" + contact.Phone + "</strong> của bạn,";
                content += "VietnamWatches hi vọng bạn hài lòng về phản hồi này!</p>";
                content += "</div> </div>";
                ...
                content += "Được phản hồi bởi: VietnamWatches";
                content += "</p>";
                ...
                content += "<div class='m_7831722724794612886product-productInfo-subInfo'><span style='font-size:14px'>Phản hồi từ VietnamWatches: " + contact.ReplayDetail + "</span></div";
                content += "</td></tr> </tbody></table></div>";
                content += "</div> </div>";
                content += "<br>";
                content += "<table cellpadding='0' cellspacing='0' class='m_7831722724794612886checkout-amount'>";
                content += "<tbody><tr>";
                content += "<td valign='top' style='color:#585858;width:80%'>Cảm ơn bạn về những phản hồi tích cực, VietnamWatches xin phép ghi nhận và sẽ khắc phục sớm nhất những phản hồi của quý khách hàng. Thân!</td>";
                content += "</tr>";
                content += "</tbody></table>";
                content += "</td></tr></tbody></table></div>";
